...
* [CodeReview-0013.tar.gz]({{site.baseurl}}/images/0013-CodeReview/CodeReview-0013.tar.gz) (まとめてダウンロード)
...
![format.png]({{site.baseurl}}/images/0013-CodeReview/format.png)
...
ここで使っているのはそれをわたしが大幅に改造したものです ([rdefs.rb]({{site.baseurl}}/images/0013-CodeReview/rdefs.rb))。
