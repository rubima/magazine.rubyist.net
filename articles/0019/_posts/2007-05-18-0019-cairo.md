...
![objects-without-aa-and-alpha.png]({{site.baseurl}}/images/0019-cairo/objects-without-aa-and-alpha.png)
![objects-with-aa-and-alpha.png]({{site.baseurl}}/images/0019-cairo/objects-with-aa-and-alpha.png)
...
![screenshot-arc.png]({{site.baseurl}}/images/0019-cairo/screenshot-arc.png)
![screenshot-clip-image.png]({{site.baseurl}}/images/0019-cairo/screenshot-clip-image.png)
![screenshot-clip.png]({{site.baseurl}}/images/0019-cairo/screenshot-clip.png)
![screenshot-curve-rectangle.png]({{site.baseurl}}/images/0019-cairo/screenshot-curve-rectangle.png)
![screenshot-curve.png]({{site.baseurl}}/images/0019-cairo/screenshot-curve.png)
![screenshot-dash.png]({{site.baseurl}}/images/0019-cairo/screenshot-dash.png)
![screenshot-gradient.png]({{site.baseurl}}/images/0019-cairo/screenshot-gradient.png)
![screenshot-image-pattern.png]({{site.baseurl}}/images/0019-cairo/screenshot-image-pattern.png)
![screenshot-line-cap.png]({{site.baseurl}}/images/0019-cairo/screenshot-line-cap.png)
![screenshot-line-join.png]({{site.baseurl}}/images/0019-cairo/screenshot-line-join.png)
![screenshot-text-extents.png]({{site.baseurl}}/images/0019-cairo/screenshot-text-extents.png)
![screenshot-text-on-path.png]({{site.baseurl}}/images/0019-cairo/screenshot-text-on-path.png)
![screenshot-text-path.png]({{site.baseurl}}/images/0019-cairo/screenshot-text-path.png)
...
|---|---|
|  ![lena.jpg]({{site.baseurl}}/images/0019-cairo/lena.jpg)|  ![lena-resized.jpg]({{site.baseurl}}/images/0019-cairo/lena-resized.jpg) |
...
を割り当てればよいのかを計算します。
![raster-and-vector-draw-line.png]({{site.baseurl}}/images/0019-cairo/raster-and-vector-draw-line.png)
...
![context-draw-line.png]({{site.baseurl}}/images/0019-cairo/context-draw-line.png)
...
での線を描くようにします。
![context-move-by-matrix.png]({{site.baseurl}}/images/0019-cairo/context-move-by-matrix.png)
...
象化しているからです。
![cairo-multi-output.png]({{site.baseurl}}/images/0019-cairo/cairo-multi-output.png)
...
![blur.png]({{site.baseurl}}/images/0019-cairo/blur.png)
...
![pseudo-blur.png]({{site.baseurl}}/images/0019-cairo/pseudo-blur.png)
...
![surface-and-context.png]({{site.baseurl}}/images/0019-cairo/surface-and-context.png)

### 例: 日の丸

それでは、日の丸を描いてみましょう。出力結果はこうなります。
![hinomaru.png]({{site.baseurl}}/images/0019-cairo/hinomaru.png)

スクリプトは以下のようになります。

スクリプト: [hinomaru.rb]({{site.baseurl}}/images/0019-cairo/hinomaru.rb)
...
![rectangle-and-rounded-rectangle.png]({{site.baseurl}}/images/0019-cairo/rectangle-and-rounded-rectangle.png)
...
![red-rectangle-with-black-border.png]({{site.baseurl}}/images/0019-cairo/red-rectangle-with-black-border.png)
...
![basic-conclusion.png]({{site.baseurl}}/images/0019-cairo/basic-conclusion.png)
...
ような関係になります。
![cairo-with-rendering-libraries.png]({{site.baseurl}}/images/0019-cairo/cairo-with-rendering-libraries.png)
...
スクリプト: [svg2png.rb]({{site.baseurl}}/images/0019-cairo/svg2png.rb)
...
スクリプト: [png-to-inverted-jpeg.rb]({{site.baseurl}}/images/0019-cairo/png-to-inverted-jpeg.rb)
...
スクリプト: [image2png.rb]({{site.baseurl}}/images/0019-cairo/image2png.rb)
...
スクリプト: [image2pdf.rb]({{site.baseurl}}/images/0019-cairo/image2pdf.rb)
...
![rubima_logo.png]({{site.baseurl}}/images/0019-cairo/rubima_logo.png)
[rubima_logo.pdf]({{site.baseurl}}/images/0019-cairo/rubima_logo.pdf)
...
れます。
![source-as-carbon-paper.png]({{site.baseurl}}/images/0019-cairo/source-as-carbon-paper.png)

しかし、普通のカーボン紙とは違って単色とは限りません。グラデー
ションやサーフェスに描画した内容を使うことも出来ます。
![several-sources.png]({{site.baseurl}}/images/0019-cairo/several-sources.png)
...
![paint-without-alpha-and-paint-with-alpha.png]({{site.baseurl}}/images/0019-cairo/paint-without-alpha-and-paint-with-alpha.png)
...
![image2pdf-with-margin-output.png]({{site.baseurl}}/images/0019-cairo/image2pdf-with-margin-output.png)

この例では左隅に画像を配置するのではなく、任意の場所に配置す
る方法を示します。実際のスクリプトは以下のようになります。

スクリプト: [image2pdf-with-margin.rb]({{site.baseurl}}/images/0019-cairo/image2pdf-with-margin.rb)
...
はパスをずらします。
![translate-source-and-path.png]({{site.baseurl}}/images/0019-cairo/translate-source-and-path.png)
...
* [rubykaigi2007-trailer-thumb.pdf]({{site.baseurl}}/images/0019-cairo/rubykaigi2007-trailer-thumb.pdf)


スクリプト: [pdf-thumbnail.rb]({{site.baseurl}}/images/0019-cairo/pdf-thumbnail.rb)
...
![pdf-thumbnail-pages.png]({{site.baseurl}}/images/0019-cairo/pdf-thumbnail-pages.png)
...
スクリプト: [text2ps.rb]({{site.baseurl}}/images/0019-cairo/text2ps.rb)
...
[text2ps-to-text2ps.ps]({{site.baseurl}}/images/0019-cairo/text2ps-to-text2ps.ps)
...
![pango-layout-align.png]({{site.baseurl}}/images/0019-cairo/pango-layout-align.png)
![pango-layout-characters-per-line.png]({{site.baseurl}}/images/0019-cairo/pango-layout-characters-per-line.png)
...
![pango-markup.png]({{site.baseurl}}/images/0019-cairo/pango-markup.png)
...
スクリプト: [image-viewer.rb]({{site.baseurl}}/images/0019-cairo/image-viewer.rb)
