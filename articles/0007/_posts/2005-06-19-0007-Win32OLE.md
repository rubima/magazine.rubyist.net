...
まず、下記のクラス図を参照してください。
![Outlook_Object_Model.png]({{site.baseurl}}/images/0007-Win32OLE/Outlook_Object_Model.png)
...
[inbox.rb]({{site.baseurl}}/images/0007-Win32OLE/inbox.rb)
...
![Outlook.PNG]({{site.baseurl}}/images/0007-Win32OLE/Outlook.PNG)
...
ポップアップします。
![Outlook_Address_Warn.PNG]({{site.baseurl}}/images/0007-Win32OLE/Outlook_Address_Warn.PNG)
...
[search.rb]({{site.baseurl}}/images/0007-Win32OLE/search.rb)
...
![python_object_browser.PNG]({{site.baseurl}}/images/0007-Win32OLE/python_object_browser.PNG)
...
![AdvancedSearch.PNG]({{site.baseurl}}/images/0007-Win32OLE/AdvancedSearch.PNG)

これを使うと次の画面のように、簡単にフィールドに対する
検索条件から、生成される文字列がどのようになるのかについて
確認できます。

![AdvancedSearch_SQL.PNG]({{site.baseurl}}/images/0007-Win32OLE/AdvancedSearch_SQL.PNG)
...
[send.rb]({{site.baseurl}}/images/0007-Win32OLE/send.rb)
...
![mail_send_warn.PNG]({{site.baseurl}}/images/0007-Win32OLE/mail_send_warn.PNG)
