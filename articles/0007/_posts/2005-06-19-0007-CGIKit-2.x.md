...
* [前回のCGIKit 2.x の記事]({% post_url articles/0006/2005-05-09-0006-CGIKit-2.x %}) を読んだ人、もしくは、[CGIKit の Wiki](http://cgikit.sourceforge.jp/cgi-bin/ja/index.cgi) のチュートリアルを5章まで読んだ人
...
* サンプルのソース  [ri2ref_sample.zip]({{site.baseurl}}/images/0007-CGIKit-2.x/ri2ref_sample.zip)


インストールの方法については [前回の記事]({% post_url articles/0006/2005-05-09-0006-CGIKit-2.x %}) や CGIKit の Wiki を参照してください。
...
ファイルの名前は ri2ref_utils.rb です。CGIKit と関係がないので、実装についてはすべて省略し、各メソッドについては後ほど紹介します。[ri2ref_utils.rb]({{site.baseurl}}/images/0007-CGIKit-2.x/ri2ref_utils.rb)
...
最後の利点は [前回の記事]({% post_url articles/0006/2005-05-09-0006-CGIKit-2.x %}) で言われた文句のうち
...
components 以下のファイルを省いてありますので、完全な構成を知りたい場合はサンプルをダウンロードしてください。[ri2ref_sample.zip]({{site.baseurl}}/images/0007-CGIKit-2.x/ri2ref_sample.zip)
...
![ClassListPage.html]({{site.baseurl}}/images/0007-CGIKit-2.x/ClassListPage.html)
![list.jpg]({{site.baseurl}}/images/0007-CGIKit-2.x/list.jpg)
...
![ClassPage.rb]({{site.baseurl}}/images/0007-CGIKit-2.x/ClassPage.rb)
...
![ClassPage.html]({{site.baseurl}}/images/0007-CGIKit-2.x/ClassPage.html)
![class.jpg]({{site.baseurl}}/images/0007-CGIKit-2.x/class.jpg)
...
![MethodPage.rb]({{site.baseurl}}/images/0007-CGIKit-2.x/MethodPage.rb)
...
![MethodPage.html]({{site.baseurl}}/images/0007-CGIKit-2.x/MethodPage.html)
![method.jpg]({{site.baseurl}}/images/0007-CGIKit-2.x/method.jpg)
...
![SearchResult.html]({{site.baseurl}}/images/0007-CGIKit-2.x/SearchResult.html)
![search.jpg]({{site.baseurl}}/images/0007-CGIKit-2.x/search.jpg)
