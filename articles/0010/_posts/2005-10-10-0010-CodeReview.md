...
好評をいただきました。
![osc2005fall-pukipa.jpg]({{site.baseurl}}/images/0010-CodeReview/osc2005fall-pukipa.jpg)
...
* [pukipa.rb]({% post_url articles/0010/2005-10-10-0010-CodeReview-pukipa.rb %})（別ページで表示）
...
* [pukipa.rb]({% post_url articles/0010/2005-10-10-0010-CodeReview-pukipa.rb %})（別ページで表示）
* [pukiwikiparser.rb]({% post_url articles/0010/2005-10-10-0010-CodeReview-pukiwikiparser.rb %})（別ページで表示）
* [osc2005-ruby.tar.gz]({{site.baseurl}}/images/0010-CodeReview/osc2005-ruby.tar.gz)（まとめてダウンロード）
...
改善前：
![pukipa.png]({{site.baseurl}}/images/0010-CodeReview/pukipa.png)

改善後：
![pukiwikiparser.png]({{site.baseurl}}/images/0010-CodeReview/pukiwikiparser.png)
