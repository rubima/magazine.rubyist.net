...
5. **自分でゼロから設計する**：
    市販品でもカスタムキーボードでも自作キットでも満足できない人には、自分でハードウェアや回路からすべて設計するという道が待っています。PCB 基板を頒布したり回路図や CAD データを公開したりするまでいかなくても、[KeebKaigi オーガナイザのお一人である魔王さん](https://twitter.com/swan_match ) による[無限の可能性](https://swanmatch.github.io/MxLEDBitPCB/) のような便利な商品が登場したおかげで、個人として楽しむぶんにはそこまで高いハードルではなくなっています。
