...
[^2]: 編集部注: 1人ずつの抽選を行う際には["`deck.shuffle!.pop` のように `Array#shuffle!` して `Array#pop` すると、重複が起きず読み札がなくなったら終了"](https://blog.agile.esm.co.jp/entry/ruby-method-karuta-retrospective) というコードが良さそうです。
