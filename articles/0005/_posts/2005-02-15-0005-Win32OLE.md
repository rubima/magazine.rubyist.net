...
持ちます。
![designview.png]({{site.baseurl}}/images/0005-Win32OLE/designview.png)

サンプルとして、次の mdb ファイルを用意します。
ダウンロードして使ってください。
[sample1.mdb]({{site.baseurl}}/images/0005-Win32OLE/sample1.mdb)

### 一行レコードを追加するスクリプト

[insert1record.rb]({{site.baseurl}}/images/0005-Win32OLE/insert1record.rb)
...
[csv2rs.rb]({{site.baseurl}}/images/0005-Win32OLE/csv2rs.rb)
...
サンプルの CSV がここにあります。
[sample1.csv]({{site.baseurl}}/images/0005-Win32OLE/sample1.csv)
...
[rs2csv.rb]({{site.baseurl}}/images/0005-Win32OLE/rs2csv.rb)
...
[addnew.rb]({{site.baseurl}}/images/0005-Win32OLE/addnew.rb)
...
[update.rb]({{site.baseurl}}/images/0005-Win32OLE/update.rb)
...
[select.rb]({{site.baseurl}}/images/0005-Win32OLE/select.rb)
