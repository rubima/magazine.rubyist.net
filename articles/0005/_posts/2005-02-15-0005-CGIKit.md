...
細かい内容はるびま 4 号の記事「[Ruby Library Report --- [第3回] O/R マッピング]({% post_url articles/0004/2004-12-17-0004-RLR %})」を参考にしてください。
...
![MainPage.html]({{site.baseurl}}/images/0005-CGIKit/MainPage.html)
[MainPage.html]({{site.baseurl}}/images/0005-CGIKit/MainPage.html)
...
![MainPage.ckd.txt]({{site.baseurl}}/images/0005-CGIKit/MainPage.ckd.txt)
[MainPage.ckd]({{site.baseurl}}/images/0005-CGIKit/MainPage.ckd)

コード (MainPage/MainPage.rb)

![MainPage.rb]({{site.baseurl}}/images/0005-CGIKit/MainPage.rb)
[MainPage.rb]({{site.baseurl}}/images/0005-CGIKit/MainPage.rb)
...
今回製作した BBS のソースは [bbs.tar.gz]({{site.baseurl}}/images/0005-CGIKit/bbs.tar.gz) になります。
