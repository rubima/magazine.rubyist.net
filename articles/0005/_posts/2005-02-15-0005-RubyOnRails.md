...
![new_topic.gif]({{site.baseurl}}/images/0005-RubyOnRails/new_topic.gif)
![list_topic.gif]({{site.baseurl}}/images/0005-RubyOnRails/list_topic.gif)
![show_topic.gif]({{site.baseurl}}/images/0005-RubyOnRails/show_topic.gif)
![edit_topic.gif]({{site.baseurl}}/images/0005-RubyOnRails/edit_topic.gif)
...
![scaffold-1.gif]({{site.baseurl}}/images/0005-RubyOnRails/scaffold-1.gif)
scaffold が自動生成するアクションの関係を図にするとこうなります。
scaffold を使わない場合にも、同様のアクション名を付けたほうがわかりやすくて良いと思います。

### scaffold が用意する template
![scaffold-2.gif]({{site.baseurl}}/images/0005-RubyOnRails/scaffold-2.gif)
...
### template と action
![scaffold-3.gif]({{site.baseurl}}/images/0005-RubyOnRails/scaffold-3.gif)
...
![scaffold-4.gif]({{site.baseurl}}/images/0005-RubyOnRails/scaffold-4.gif)
...
![scaffold-5.gif]({{site.baseurl}}/images/0005-RubyOnRails/scaffold-5.gif)
