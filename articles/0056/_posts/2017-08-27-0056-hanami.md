...
図にすると次のようになる。
![hanami-ddd.png]({{site.baseurl}}/images/0056-hanami/hanami-ddd.png)
...
また、Rails 同様 _resources_ メソッドを用いることで RESTful Resource を定義できる。
...
![hanami-ddd-service.png]({{site.baseurl}}/images/0056-hanami/hanami-ddd-service.png)
...
[https://github.com/hanami/events](https://github.com/hanami/events)
