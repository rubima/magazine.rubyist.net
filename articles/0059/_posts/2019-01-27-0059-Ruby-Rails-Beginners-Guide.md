...
追記(2019年8月29日): 2019年4月に行われた技術書典6で加筆改訂版を出すことができました。電子書籍版を [BOOTH 「RubyとRailsの学習ガイド 2019 技術書典6 拡大版」](https://igaigarb.booth.pm/items/1312664) から購入可能です。「OpenAPI, Swagger」、「IDE」について加筆したほか、本稿の内容も公開後にいただいたフィードバックや追調査した結果で更新しています。
