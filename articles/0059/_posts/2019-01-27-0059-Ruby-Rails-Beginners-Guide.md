...
追記(2019年9月1日): 本稿公開後、加筆改訂版を2019年4月に行われた技術書典6にて出版しました。技術全体図をイラストで描き、トピックを増やし、本稿公開後にいただいたフィードバックや追調査した結果で本記事の内容も改訂しています。加筆改訂版は [BOOTH](https://igaigarb.booth.pm/items/1312664) にて電子書籍版を購入できます。
