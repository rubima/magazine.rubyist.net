...
* [0009号のCGIKit2の付録ページ]({% post_url articles/0009/2005-09-06-0009-CGIKit-2.x-Nvu-Brushup %})
...
* Nvu-1.0
* サンプルのソース [rubima-ck0009.zip]({{site.baseurl}}/images/0009-CGIKit-2.x/rubima-ck0009.zip)
...
__スクリーンショット__
![demo.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/demo.jpg)
...
別ページに分割しています。詳細は 
[今号のCGIKit2の付録ページ]({% post_url articles/0009/2005-09-06-0009-CGIKit-2.x-Nvu-Brushup %}) へどうぞ。
...
![nvu_file_new.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/nvu_file_new.jpg)

次に index.html として保存します。メニューの File -&gt; Save を選ぶと
タイトルを聞かれるので、適当にタイトル名をつけます。
![nvu_file_save.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/nvu_file_save.jpg)
...
![nvu_insert_link.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/nvu_insert_link.jpg)
...
![index_page.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/index_page.jpg)

index.html
![index.html]({{site.baseurl}}/images/0009-CGIKit-2.x/index.html)

これで少しは Nvu に馴れたでしょうか?
デザインは CGIKit と関係ないので、ここでは扱いません。
[付録ページ]({% post_url articles/0009/2005-09-06-0009-CGIKit-2.x-Nvu-Brushup %})に CSS を
...
![nvu_form.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/nvu_form.jpg)
...
![nvu_textfield.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/nvu_textfield.jpg)

以下、同じ要領で Nvu に入力していきます。
おおよそ下のような図になるようにします。
![nvu_regsiter_page1.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/nvu_regsiter_page1.jpg)
...
修正の結果、最終的に下のようになります。
![RegisterPage.html]({{site.baseurl}}/images/0009-CGIKit-2.x/RegisterPage.html)
...
[付録ページ]({% post_url articles/0009/2005-09-06-0009-CGIKit-2.x-Nvu-Brushup %})でも説明していますので、
...
今号の [標準添付ライブラリ紹介【第 3 回】Kconv/NKF/Iconv]({% post_url articles/0009/2005-09-06-0009-BundledLibraries %})
...
![registerpage.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/registerpage.jpg)
...
Insert -&gt; Table を選択します。
![nvu_table.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/nvu_table.jpg)
...
![nvu_confirm.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/nvu_confirm.jpg)
...
![nvu_field_prop.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/nvu_field_prop.jpg)

この後は RegisterPage.html のように ckid 属性を付けていきます。
下に修正後の HTML のソースを載せます。この HTML には簡単に CSS も記述してあります。
![ConfirmPage.html]({{site.baseurl}}/images/0009-CGIKit-2.x/ConfirmPage.html)
...
### スクリーンショット
![confirmpage.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/confirmpage.jpg)
...
ThanksPage.html
![ThanksPage.html]({{site.baseurl}}/images/0009-CGIKit-2.x/ThanksPage.html)
...
### スクリーンショット
![thankspage.jpg]({{site.baseurl}}/images/0009-CGIKit-2.x/thankspage.jpg)
