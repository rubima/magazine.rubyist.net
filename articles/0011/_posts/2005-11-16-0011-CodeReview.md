...
* [hex_struct.rb]({% post_url articles/0011/2005-11-16-0011-CodeReview-hex_struct.rb %}) (別ページで表示)
* [test_hexstruct.rb]({% post_url articles/0011/2005-11-16-0011-CodeReview-test_hexstruct.rb %}) (別ページで表示)
* [hexstruct.tar.gz]({{site.baseurl}}/images/0011-CodeReview/hexstruct.tar.gz) (まとめてダウンロード)
...
![before.jpg]({{site.baseurl}}/images/0011-CodeReview/before.jpg)
...
つまり次のような構造です。
![after.jpg]({{site.baseurl}}/images/0011-CodeReview/after.jpg)
...
* [hex_struct.rb]({% post_url articles/0011/2005-11-16-0011-CodeReview-hex_struct.rb %}) (別ページで表示)
* [test_hexstruct.rb]({% post_url articles/0011/2005-11-16-0011-CodeReview-test_hexstruct.rb %}) (別ページで表示)
* [hexstruct2.rb]({% post_url articles/0011/2005-11-16-0011-CodeReview-hexstruct2.rb %}) (別ページで表示)
* [test_hexstruct2.rb]({% post_url articles/0011/2005-11-16-0011-CodeReview-test_hexstruct2.rb %}) (別ページで表示)
* [hexstruct.tar.gz]({{site.baseurl}}/images/0011-CodeReview/hexstruct.tar.gz) (まとめてダウンロード)
