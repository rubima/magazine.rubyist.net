...
[前回の問題]({% post_url articles/0026/2009-06-30-0026-RubiMaGolf %})は Unix の seq コマンドのようなものを実装する、というものでした。入力は
...
edvakf さんはもう一つ、前置 * を使って .to_a を代用する工夫もしておられます。この演算は[前回]({% post_url articles/0026/2009-06-30-0026-RubiMaGolf %})も紹介したのですが、今回は関数の引数を展開する意味で使われていて、厳密には .to_a とは違う動作になります。例えば puts *'3'..'5' であれば
