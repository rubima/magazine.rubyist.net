...
[Rubyist Hotlinks 【第 34 回】 大場さん夫妻 後編]({% post_url articles/0045/2013-12-21-0045-Hotlinks %})、
vagrant と chef-solo の組み合わせで仮想マシン上に開発環境を構築する方法を春山さんが紹介する
[vagrantとchef-soloを使った開発環境の構築]({% post_url articles/0045/2013-12-21-0045-SetupDevelopmentEnvWIthVagrantAndChefSolo %})、
@kentaro さんの『入門 Puppet』を @hsbt さんがダイジェスト版としてまとめた
[入門 Puppet ダイジェスト]({% post_url articles/0045/2013-12-21-0045-PuppetBook %})、
カンファレンスレポートとしてマイアミの空がまぶしかった
[RubyConf 2013 参加レポート]({% post_url articles/0045/2013-12-21-0045-RubyConf2013 %})と、松江の秋を堪能した
[RubyWorld Conference 2013 参加レポート]({% post_url articles/0045/2013-12-21-0045-RubyWorld_Conference_2013_report %})、
さらに地域 Ruby 会議レポートとして
[RegionalRubyKaigi レポート (41) 関西 Ruby 会議 05]({% post_url articles/0045/2013-12-21-0045-KansaiRubyKaigi05Report %})と
[RegionalRubyKaigi レポート (42) とちぎ Ruby 会議 05]({% post_url articles/0045/2013-12-21-0045-TochigiRubyKaigi05Report %})となっている。
