...
![nora_neko.png]({{site.baseurl}}/images/0002-NoraTutorial/nora_neko.png)前回の記事では Nora の最低限の入出力の方法だけ書きました。今回は _Hello World!_ から一歩進んでテンプレートについて紹介します。
