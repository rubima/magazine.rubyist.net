...
みなさん、[mruby](https://github.com/mruby/mruby) を使ったことはありますか？ mruby は組込み用途向けの「軽量 Ruby」のことで、るびまでも過去に [0038 号 巻頭言]({% post_url articles/0038/2012-05-22-0038-ForeWord %}) や [0040 号 巻頭言]({% post_url articles/0040/2012-11-25-0040-ForeWord %}) で取り上げられていますね。
...
![codefetch.png]({{site.baseurl}}/images/0050-nomitory/codefetch.png)
...
![bytecode3.png]({{site.baseurl}}/images/0050-nomitory/bytecode3.png)
...
![bytecode-output5.png]({{site.baseurl}}/images/0050-nomitory/bytecode-output5.png)
